...
The authors do NOT claim any right to the data generated using this
script.  License of generated data fully depends on the intention of
the author(s) of source data used to generate them.

=cut

1; ## $Date: 2008/11/08 04:25:59 $
